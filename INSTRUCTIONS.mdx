...
### 💡 Lancer des tests d’autorisation
...
📑 Le lien vers la doc [Vitest Documentation](https://vitest.dev/).
...
Remplir le [formulaire de FeedBack](https://go.mikecodeur.com/cours-next-avis?entry.1912869708=Next%20Mastery&entry.1430994900=8.Next%20Testing&entry.533578441=03%20Test-service%20Autorisation).
